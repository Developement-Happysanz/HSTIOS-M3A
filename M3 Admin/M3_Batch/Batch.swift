...
class Batch: UIViewController,UITableViewDataSource,UITableViewDelegate
{
    ...
    {
        self.performSegue(withIdentifier: "addBatch", sender: self)
    }
    ...
    func webRequest ()
    {
        let functionName = "apipia/list_batch"

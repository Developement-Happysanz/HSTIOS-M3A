...
//        }
    ...
    @objc func clickButton()
    {
        ...
        self.performSegue(withIdentifier: "addWorkType", sender: self)
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
            ...
            self.mobilizerComments = mobilizer_comments [indexPath.row]
    ...
    {
        self.performSegue(withIdentifier: "to_DetailedReport", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "taskDetails")
        {
            ...
            vc._mobilizerComments = self.mobilizerComments

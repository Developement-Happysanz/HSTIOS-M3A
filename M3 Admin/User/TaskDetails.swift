...
class TaskDetails: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate, UITextViewDelegate {
    ...
    @IBOutlet weak var mobilizerComments: UITextField!
    ...
    override func viewDidLoad() {
        ...
        self.mobilizerComments.text = _mobilizerComments
    ...
    {
        self.performSegue(withIdentifier: "to_updateTask", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "to_updateTask")
        {
            let vc = segue.destination as! UpdateTask
            vc.titleText = self.titleLabel.text!
            vc.descripition = self.descripitionText.text!
            vc.date = self.taskDate.text!
            vc._taskType = self.taskType.text!
            vc.status = self.taskStatus.text!
